...
export const stage0: DominoType[] = [
  { position: [0, dominoPosY, 3.2], color: randomColor() },
  { position: [0, dominoPosY, 2.4], color: randomColor() },
  // { position: [0, dominoPosY, 1.5], color: randomColor() },
  // { position: [0, dominoPosY, 0.6], color: randomColor() },
  // { position: [0, dominoPosY, -0.3], color: randomColor() },
