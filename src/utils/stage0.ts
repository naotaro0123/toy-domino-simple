import { dominoHeight, dominoPosY, DominoType } from '../components/InstancedDomino';
import { randomColor } from './color';

export const stage0: DominoType[] = [
  { position: [0, dominoPosY, 3.2], rotation: [0, 0, 0], color: randomColor() },
  { position: [0, dominoPosY, 2.4], rotation: [0, 0, 0], color: randomColor() },
  { position: [0, dominoPosY, 1.5], rotation: [0, 0, 0], color: randomColor() },
  { position: [0, dominoPosY, 0.6], rotation: [0, 0, 0], color: randomColor() },
  { position: [0, dominoPosY, -0.3], rotation: [0, 0, 0], color: randomColor() },
  { position: [0, dominoPosY, -1.0], rotation: [0, 0, 0], color: randomColor() },
  ...
  { position: [4.4, dominoPosY, -1.4], rotation: [0, 0, 0], color: randomColor() },
  { position: [4.4, dominoPosY, -0.6], rotation: [0, 0, 0], color: randomColor() },
