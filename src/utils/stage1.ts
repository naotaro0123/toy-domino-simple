...
const numberDominoLine = (posX: number, colors: string[]): DominoType[] => {
  return [
    ...
    { position: [posX, dominoPosY, 2], rotation, color: colors[1] },
    ...
    { position: [posX, dominoPosY, -2], rotation, color: colors[6] },
...
export const stage1: DominoType[] = [
  // line 1
  { position: [-8.5, dominoPosY, 0], rotation, color: colorBlack },
  // line 2
  { position: [-8, dominoPosY, 0], rotation, color: colorBlack },
  // line 3
  { position: [-7.5, dominoPosY, 0], rotation, color: colorBlack },
  // line 4
  { position: [-7, dominoPosY, 0.4], rotation, color: colorBlack },
  { position: [-7, dominoPosY, -0.4], rotation, color: colorBlack },
  // line 5
  { position: [-6.5, dominoPosY, 0.8], rotation, color: colorBlack },
  { position: [-6.5, dominoPosY, 0], rotation, color: colorBlack },
  { position: [-6.5, dominoPosY, -0.8], rotation, color: colorBlack },
  // line 6
  { position: [-6, dominoPosY, 1.2], rotation, color: colorBlack },
  { position: [-6, dominoPosY, 0.4], rotation, color: colorBlack },
  { position: [-6, dominoPosY, -0.4], rotation, color: colorBlack },
  { position: [-6, dominoPosY, -1.2], rotation, color: colorBlack },
  // line 7
  { position: [-5.5, dominoPosY, 1.6], rotation, color: colorBlack },
  { position: [-5.5, dominoPosY, 0.8], rotation, color: colorBlack },
  { position: [-5.5, dominoPosY, 0], rotation, color: colorBlack },
  { position: [-5.5, dominoPosY, -0.8], rotation, color: colorBlack },
  { position: [-5.5, dominoPosY, -1.6], rotation, color: colorBlack },
  // line 8
  { position: [-5, dominoPosY, 2], rotation, color: colorBlack },
  { position: [-5, dominoPosY, 1.2], rotation, color: colorBlack },
  { position: [-5, dominoPosY, 0.4], rotation, color: colorBlack },
  { position: [-5, dominoPosY, -0.4], rotation, color: colorBlack },
  { position: [-5, dominoPosY, -1.2], rotation, color: colorBlack },
  { position: [-5, dominoPosY, -2], rotation, color: colorBlack },
  // line 9
  ...
  { position: [-4.5, dominoPosY, 0], rotation, color: colorBlack },
  { position: [-4.5, dominoPosY, -0.8], rotation, color: colorBlack },
  { position: [-4.5, dominoPosY, -1.6], rotation, color: colorBlack },
  { position: [-4.5, dominoPosY, -2.4], rotation, color: colorBlack },
  // line 10
  { position: [-4, dominoPosY, 2.8], rotation, color: colorBlack },
  { position: [-4, dominoPosY, 2], rotation, color: colorBlack },
  { position: [-4, dominoPosY, 1.2], rotation, color: colorBlack },
  { position: [-4, dominoPosY, 0.4], rotation, color: colorBlack },
  { position: [-4, dominoPosY, -0.4], rotation, color: colorBlack },
  { position: [-4, dominoPosY, -1.2], rotation, color: colorBlack },
  { position: [-4, dominoPosY, -2], rotation, color: colorBlack },
  { position: [-4, dominoPosY, -2.8], rotation, color: colorBlack },
  ...
  // number line 2
  ...numberDominoLine(-3, [...Array.from({ length: 8 }, () => colorWhite)]),
  // number line 3
  ...numberDominoLine(-2.5, [...Array.from({ length: 8 }, () => colorWhite)]),
  // number line 4
  ...numberDominoLine(-2, [...Array.from({ length: 8 }, () => colorWhite)]),
  // number line 5
  ...
  // number line 20
  ...numberDominoLine(6, [...Array.from({ length: 8 }, () => colorWhite)]),
  // number line 21
  ...numberDominoLine(6.5, [...Array.from({ length: 8 }, () => colorWhite)]),
  // number line 22
  ...numberDominoLine(7, [...Array.from({ length: 8 }, () => colorWhite)]),
  // number line 23
  ...numberDominoLine(7.5, [...Array.from({ length: 8 }, () => colorWhite)]),
  // number line 24
  ...numberDominoLine(8, [...Array.from({ length: 8 }, () => colorWhite)]),
];
